...
<head>
  ...
  <title>Evisas - Certificate of Temporary Stay (SKTT)</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Certificate of Temporary Stay (SKTT)</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>Certificate of Temporary Stay (SKTT)</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: SKTT - Residency Certificate -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">SKTT - Residency Certificate</h2>
      ...
      <div class="mb-4">
        ...
        <p>
          Certificate of Temporary Stay (SKTT) for foreign nationals, required for administrative purposes in Indonesia.
        </p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Processing Time</h3>
        <p>Typically <strong>3–7 business days</strong> after submission of required documents</p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Marriage certificate (if married to Indonesian)</li>
          <li>Other supporting documents based on case</li>
        </ul>
      </div>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for a SKTT (Residency Certificate).\nCould you please assist me with the process? Thank you!`)"
          target="_blank"
    ...
    <div class="max-w-3xl mx-auto text-sm text-gray-600 mb-10 px-6">
      ...
      <ul class="list-disc pl-6 space-y-1">
        <li>Required for legal compliance of foreign residents staying in Indonesia temporarily.</li>
        <li>Often needed for administrative tasks such as local registration and public services.</li>
      </ul>
    </div>

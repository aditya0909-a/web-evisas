...
<head>
  ...
  <title>Evisas - New NPWP - Taxpayer ID</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">New NPWP - Taxpayer ID</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>New NPWP - Taxpayer ID</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: New NPWP - Taxpayer ID -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">New NPWP - Taxpayer ID</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p><strong>IDR 880,000</strong> – For individual or business NPWP application</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Description</h3>
        <p>
          Application for a new Taxpayer Identification Number (NPWP) for individuals or businesses.
        </p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Processing Time</h3>
        <p>Usually <strong>2–5 business days</strong> depending on completeness of documents</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Requirements</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Copy of Passport or KTP</li>
          <li>Copy of KITAS (for foreigners)</li>
          <li>Business license (for company NPWP)</li>
          <li>Domicile letter (if required)</li>
        </ul>
      </div>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for a New NPWP (Taxpayer ID).\nCould you please assist me with the process? Thank you!`)"
          target="_blank"
    ...
    <div class="max-w-3xl mx-auto text-sm text-gray-600 mb-10 px-6">
      ...
      <ul class="list-disc pl-6 space-y-1">
        <li>NPWP is a mandatory document for tax reporting and legal compliance in Indonesia.</li>
        <li>Can be registered for both individuals and legal entities.</li>
        <li>Make sure all documents are valid and translated if necessary.</li>
      </ul>
    </div>

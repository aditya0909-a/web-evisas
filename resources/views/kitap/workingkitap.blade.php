...
<head>
  ...
  <title>Evisas - Working Kitap</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Working Kitap</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">Working Kitap</h2>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Engage in any work or job outside of the work that is associated with your KITAS.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Recent color passport photo (with white background).</li>
          <li>Copy of degree in “Sarjana (Bachelor)” or “External Qualification” equivalence.</li>
          <li>Employment contract (minimum 12 months).</li>
          <li>Real Stay Permit Card (KITAS) proving that the applicant has lived in Indonesia for the last 2 years.</li>
          <li>Latest company bank account statement.</li>
          <li>Company deed of establishment and its amendments.</li>
          <li>Approval from the Ministry of Law and Human Rights (MoUHR) of company.</li>
          <li>NPWP of company.</li>
          <li>OSS documents (NIB, Izin Usaha, Izin Lokasi).</li>
          <li>Copy of the applicant's passport ID section & card (KITAS).</li>
          <li>Company letterhead and company stamp.</li>
          <li>Copy TKA (foreign worker) data of other company.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the Working Kitap.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

...
<head>
  ...
  <title>Evisas - Retirement Kitas</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Retirement Kitas</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Retirement Kitap -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">Retirement Kitap</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p class="text-sm text-gray-700 mb-1">
          <strong>IDR 50,000,000</strong> – Regular – <strong>60 business days processing time</strong>
        </p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Have stable residency status for five years, with the possibility of extension.</li>
          <li>Be eligible for a local ID card (E-KTP), facilitating easier account access and residence.</li>
          <li>Participate in non-profit activities such as voluntary work, hobbies, and social activities.</li>
          <li>Travel in and out of Indonesia.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Work or be employed in Indonesia.</li>
          <li>Neglect the financial requirements such as proof of income and health insurance.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Proof of income: minimum USD $1500 / month and a copy of lease agreement.</li>
          <li>One white background photo.</li>
          <li>Valid health insurance policy.</li>
          <li>Limited Stay Permit Card (KITAS) proving that the applicant has lived in Indonesia for the last 2 (two) consecutive years.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the Retirement Kitap.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

...
<head>
  ...
  <title>Evisas - Investor Kitap</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Investor Kitap</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Investor Kitap -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">Investor Kitap</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p class="text-sm text-gray-700 mb-1"><strong>IDR 55,000,000</strong> – 60 business days processing time</p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Engage in social, educational, and cultural activities.</li>
          <li>Engage in investment activities for your company.</li>
          <li>Engage in non-commercial activities and festivals.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Engage in any work or job outside of the investment activities within the company you have invested in.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>NPWP (Tax Filing Number).</li>
          <li>PMA (Foreign Investment Company) Document.</li>
          <li>Real Stay Permit Card (Kitas) proving that the applicant has lived in Indonesia for the last 2 years.</li>
          <li>Latest company bank statement for the past 3 months.</li>
          <li>Company deed of establishment and its amendments.</li>
          <li>Proof of capital investment of at least IDR 10,000,000,000 (Ten billion rupiah) or equivalent in the guarantor company listed in the Ministry of Investment or BKPM.</li>
          <li>Tax Registration Number (NPWP) of company.</li>
          <li>Approval from the Ministry of Law and Human Rights (KUMHAM).</li>
          <li>Copy of the applicant’s passport ID section, E-KTP, or KITAS.</li>
          <li>Company letterhead and company stamp.</li>
        </ul>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the Investor Kitap.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

...
<head>
  ...
  <title>Evisas - Legal Document Services</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Legal Document Services</span>
  </h2>
</div>
</section>
...
<div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
  <h3 class="text-xl font-semibold text-gray-800 mb-3">Domicile Letter</h3>
  <p class="text-sm text-gray-600 mb-2">Official statement verifying your business or residential address (excluding neighborhood/banjar confirmation).</p>
  <p class="text-sm mb-2">Start From - <strong>Depends on Area</strong></p>
  <div class="mt-auto flex gap-3">
    <a href="/landingpage/legaldocument/domicileletter" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
  </div>
</div>

<!-- SKTT - Residency Certificate -->
<div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
  <h3 class="text-xl font-semibold text-gray-800 mb-3">SKTT - Residency Certificate</h3>
  <p class="text-sm text-gray-600 mb-2">Certificate of Temporary Stay (SKTT) for foreign nationals, required for administrative purposes in Indonesia.</p>
  <p class="text-sm mb-2">Start From - <strong>Depends on Area</strong></p>
  <div class="mt-auto flex gap-3">
    <a href="/landingpage/legaldocument/sktt" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
  </div>
</div>

<!-- New NPWP - Taxpayer ID -->
<div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
  <h3 class="text-xl font-semibold text-gray-800 mb-3">New NPWP - Taxpayer ID</h3>
  <p class="text-sm text-gray-600 mb-2">Application for a new Taxpayer Identification Number (NPWP) for individuals or businesses.</p>
  <p class="text-sm mb-2">Start From - <strong>IDR 880,000</strong></p>
  <div class="mt-auto flex gap-3">
    <a href="/landingpage/legaldocument/npwp" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
  </div>
</div>

...
<head>
  ...
  <title>Evisas - E30 - Student Visa</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E30 - Student Visa</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E30 - Student Visa -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E30 - Student Visa</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is for foreign nationals who intend to study in Indonesia.
      </p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Carry out activities related to education in Indonesia.</li>
          <li>Bring eligible members of your family.</li>
          <li>Enter and leave the territory of Indonesia as long as the re-entry permit is still valid.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Receive compensation, wages, or similar from Indonesian companies or entities.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Valid Nationality Passport of at least 6 (six) months.</li>
          <li>A recent color photograph.</li>
          <li>Proof of living expenses of at least USD $2,000 (two thousand US Dollars) or equivalent.</li>
          <li>Latest school diploma.</li>
          <li>Guarantee letter from a guarantor which is an Indonesian citizen or the educational institution where foreigners carry out their education.</li>
          <li>Recommendation letter from the educational institution in Indonesia that explains the length of time the foreigner will be enrolled in the educational institution.</li>
        </ul>
      </div>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E30 - Student Visa.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

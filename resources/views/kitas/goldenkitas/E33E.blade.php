...
<head>
  ...
  <title>Evisas - E33E - Silver Hair</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E33E - Silver Hair</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E33E Silver Hair -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E33E - Silver Hair</h2>
      <p class="text-sm text-gray-600 mb-4">
        For a person aged 60 years or older who wishes to reside in Indonesia, this visa also enables your spouse, child, or parent to apply for a long-term visa, so you can be surrounded by loved ones.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li><strong>IDR 25,000,000</strong> – 60 business days processing time</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Travel to and from Indonesia as many times as you want.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Report your address and health state-owned check to Indonesia to the immigration office within 60 days of your arrival.</li>
          <li>Always ensure sufficient funds throughout your stay in Indonesia.</li>
          <li>Follow visa rules and local laws of Indonesia.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Recent passport-size color photo.</li>
          <li>Proof of sufficient funds: minimum USD 2000 in a bank account in your name, or a State-Owned Bank of at least USD 25,000.</li>
          <li>Statement of ownership/rental of residence during stay in Indonesia.</li>
          <li>Signed commitment to reside in Indonesia or other ongoing proof of ITAS. The bank account of $25,000 can be transferred immediately after arrival.</li>
          <li>Proof of stable income or investment of USD 2000. This refers to monthly pension payments, overseas business earnings or interest, and rental income.</li>
        </ul>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E33E - Silver Hair Visa.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

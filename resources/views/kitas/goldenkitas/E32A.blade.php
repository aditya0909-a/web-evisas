...
<head>
  ...
  <title>Evisas - E32A - Ex-Indonesian Citizen</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E32A - Ex-Indonesian Citizen</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>E32A - Ex-Indonesian Citizen</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Ex-Indonesian Visa (E32 A) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">Ex-Indonesian (E32 A)</h2>
      <p class="text-sm text-gray-600 mb-4">
        The Ex-Indonesian Golden Visa is for former Indonesian citizens and their foreign children. E32 A/B Visa holders can also apply for family visas for their spouses or parents.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>5 years or 10 years:</li>
          <li><strong>IDR 25,000,000</strong> – Regular: <span>14 business days processing time</span></li>
          <li><strong>IDR 30,000,000</strong> – Priority: <span>7 business days processing time</span></li>
        </ul>
        <p class="text-sm mt-2">▶️ <a href="#" class="text-blue-600 underline">Please click here for detailed information on ex-Indonesian</a></p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Engage in activities related to reunion, and visa-related or family.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Be employed by an Indonesian company.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        <h3 class="font-semibold">Required Visa Documents</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Passport with a minimum of 6 months validity.</li>
          <li>Recent photograph (color, white background).</li>
          <li>Indonesian Government-issued ID of relative (KTP).</li>
          <li>Indonesian citizenship certificate of relative (if available).</li>
          <li>Statement of commitment in one of the following:</li>
          <ul class="list-[circle] pl-6">
            <li>Indonesian bank account in your name with a value of at least USD 2000.</li>
            <li>Those eligible to reside at a residence/house owned by an Indonesian citizen.</li>
          </ul>
          <li>Statement of commitment to comply following visa rules (in entry) given from the date of arrival.</li>
        </ul>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the Ex-Indonesian Visa (E32 A).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

...
<head>
  ...
  <title>Evisas - (E31 B/E/H) Dependent Family</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">(E31 B/E/H) Dependent Family</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>(E31 B/E/H) Dependent Family</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Dependent Family Visa (E31 B/E/H) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">Dependent Family (E31 B/E/H)</h2>
      <p class="text-sm text-gray-600 mb-4">
        Dependent Family Golden Visa is for foreigners and their Children Visa holders can also apply for family visas for their children, spouses, or parents.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li><strong>5 years:</strong> IDR 25,000,000 – 60 business days</li>
          <li><strong>10 years:</strong> IDR 35,000,000 – 60 business days</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Length of Stay</h3>
        <p>5 years or 10 years.</p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Valid Limited Stay Permit (KITAS)/Permanent Stay Permit (ITAP) of the legitimate husband or wife.</li>
          <li>Marriage certificate translated into Indonesian by a sworn translator (Spouse Golden Visa).</li>
          <li>Birth certificate of the child translated into Indonesian (Child Golden Visa).</li>
          <li>Proof of medical condition or proof of guardianship translated into Indonesian by a sworn translator (specifically for individuals 18+ who need support such as for humanitarian/health considerations).</li>
          <li>Child’s birth certificate translated into Indonesian by a sworn translator (Parent Golden Visa).</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        <h3 class="font-semibold">Additional Certificates Required by Relation</h3>

        <h4 class="font-medium mt-2">Additional Certificate required for Spouse</h4>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Marriage certificate translated into Indonesian by a sworn translator.</li>
        </ul>

        <h4 class="font-medium mt-2">Additional document required for Child</h4>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Birth certificate translated into Indonesian by a sworn translator.</li>
          <li>Proof of medical condition or guardianship translated into Indonesian by a sworn translator (specifically for individuals 18+ with humanitarian/health needs).</li>
        </ul>

        <h4 class="font-medium mt-2">Additional document required for Parent</h4>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>The child’s birth certificate translated into Indonesian by a sworn translator.</li>
        </ul>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the Dependent Family Visa (E31 B/E/H).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

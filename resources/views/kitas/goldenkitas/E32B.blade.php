...
<head>
  ...
  <title>Evisas - E32B - Descendant of an Ex-Indonesian Citizen</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E32B - Descendant of an Ex-Indonesian Citizen</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>E32B - Descendant of an Ex-Indonesian Citizen</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E32B Descendant of Ex-Indonesian -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E32B - Descendant of an Ex-Indonesian Citizen (5 or 10 Years)</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is intended for individuals whose parent or grandparent was Indonesian but have since acquired foreign citizenship. It allows them to stay in Indonesia for 5 or 10 years, provided they meet immigration requirements.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li><strong>IDR 25,000,000</strong> – Regular: 14 business days processing time.</li>
          <li><strong>IDR 30,000,000</strong> – Priority: 7 business days processing time.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Make occasional visits for tourism, and visiting friends or family.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Proof of sufficient funds (minimum of USD $2000).</li>
          <li>Statement of commitment in one of the following:</li>
          <ul class="list-[circle] pl-6">
            <li>Indonesian Government-issued ID or address of sponsor.</li>
            <li>Indonesian bank account under applicant’s name with at least USD $2000.</li>
            <li>Those eligible to reside at a residence or house after the ITAS is granted.</li>
          </ul>
          <li>Statement of commitment to complete following obligations (in entry) days from the date of arrival.</li>
        </ul>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E32B Descendant of Ex-Indonesian Citizen Visa.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

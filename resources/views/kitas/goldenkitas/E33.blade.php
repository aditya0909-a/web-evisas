...
<head>
  ...
  <title>Evisas - E33 - Second Home</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E33 - Second Home</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Second Home Visa -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E33 - Second Home Visa</h2>
      <p class="text-sm text-gray-600 mb-4">
        The Second Home Visa (E33) is targeted to wealthy individuals who wish to maintain a residence in the country, and investors interested in Indonesian real estate or other business ventures.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>5 years: <strong>IDR 25,000,000 – 60 business days processing time</strong></li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Length of Stay</h3>
        <p>5 years (Extendable)</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">With this visa you <span class="text-green-600">CAN</span>:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Live in Indonesia for up to 5 years.</li>
          <li>Travel in and out of Indonesia multiple times without the need for additional visa.</li>
          <li>Stay permanently in Indonesia, such as apartment or house.</li>
          <li>Carry out business or investment activities within Indonesia.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Work and be employed by an Indonesian company.</li>
          <li>Apply and hold any permanent residency or citizenship in Indonesia.</li>
          <li>Automatically gain work permit rights.</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">With this visa, you <span class="text-blue-600">MUST</span>:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Submit the list or explanation of commitments within 90 days after the date of entry.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Valid Passport of at least 6 (six) months.</li>
          <li>Recent passport-size color photograph (digital format).</li>
          <li>Proof of sufficient funds: Bank account with at least USD $2000 (Two thousand US Dollars) or equivalent.</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Second commitment (must be accomplished within 90 days of entry), choose one of the following:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Own property in Indonesia (under the name of the foreigner) as one-time cash with a value of USD 128,000 (one hundred twenty-eight thousand US Dollars) or equivalent.</li>
          <li>Buy real estate/property such as an apartment/house with a value of USD 1,000,000 (one million US Dollars).</li>
        </ul>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the Second Home Visa.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

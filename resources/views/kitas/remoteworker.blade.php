...
<head>
  ...
  <title>Evisas - E33G - Digital Nomad</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E33G - Digital Nomad</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E33G - Digital Nomad -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E33G - Digital Nomad</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is for foreign nationals from overseas companies who want to live in Indonesia while working remotely.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>

        <p class="text-sm font-medium text-gray-700 underline">Applying from OUTSIDE of Indonesia</p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Carry out assignments from overseas company.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Personal bank statements with minimum balance of USD $2,000 (offshore) or USD $5,000 (onshore) equivalent for the last 3 months period (including name, dates and corresponding balances).</li>
          <li>Proof of annual income of an amount equivalent to 60,000 USD.</li>
          <li>Remote worker employment contract with overseas company.</li>
          <li>Certificate of incorporation of employing company.</li>
        </ul>
      </div>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E33G - Digital Nomad.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Family Members of Kitas Holders and long stay Visas</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>Family Members of Kitas Holders and long stay Visas</span>
  </div>
</div>

<div class="bg-[url('{{ asset('images/patternocean.svg') }}')] bg-cover py-16 overflow-hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <!-- E31B - Spousal of KITAS holder -->
        ...
        <div class="mt-auto flex gap-3">
            <a href="/landingpage/kitas/familymemberskitas/E31B" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
        </div>
      ...
      <!-- E31E - Child of KITAS holder -->
        ...
        <div class="mt-auto flex gap-3">
            <a href="/landingpage/kitas/familymemberskitas/E31E" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
        </div>
      ...
      <!-- E31H - Parent of KITAS holder -->
        ...
        <div class="mt-auto flex gap-3">
            <a href="/landingpage/kitas/familymemberskitas/E31H" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
        </div>
      </div>
    </div>

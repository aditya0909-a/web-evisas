...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E33F - Retirement Kitas</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>E33F - Retirement Kitas</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E33F - Retirement Kitas -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E33F - Retirement Kitas</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is for foreign nationals who want to retire and reside in Indonesia.
      </p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>IDR 15,000,000 – Regular 14 business days processing time.</li>
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>IDR 20,000,000 – Priority 7 business days processing time.</li>
        </ul>
      ...
      <div class="mb-4">
        ...
        <p>6 months, 1 year or 2 years.
          <a href="/landingpage/extention/retirementkitasextention" class="text-blue-600 underline">Please click here for detailed information on extension</a>
        </p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Bring eligible family to live in Indonesia.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Work for and earn money from an Indonesian entity.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Proof of income of a minimum equivalent amount of USD $3,000 per month.</li>
          <li>Life or Health Insurance.</li>
          <li>ID card (Applying from within Indonesia).</li>
          <li>Lease Agreement (Applying from within Indonesia).</li>
          <li>ITK/Permit Number (Applying from within Indonesia).</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Additional Information for applicant applying INSIDE of Indonesia</h3>
        <p class="text-sm text-gray-700">Single entry/Multiple entry e-Visa (must be valid at least 30 days before expired)</p>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E33F - Retirement Kitas.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

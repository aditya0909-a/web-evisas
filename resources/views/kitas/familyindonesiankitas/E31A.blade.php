...
<head>
  ...
  <title>Evisas - E31A - Spouse of Indonesian Citizen</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E31A - Spouse of Indonesian Citizen</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <a href="/landingpage/kitas/familymembersindonesian" class="hover:underline text-left text-blue-600">Family Indonesian Citizen</a> ›  
    <span>E31A - Spouse of Indonesian Citizen</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E31A - Spouse of Indonesian Citizen -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E31A - Spouse of Indonesian Citizen</h2>
      <p class="text-sm text-gray-600 mb-4">
        This Kitas is for husband or wife of an Indonesian citizen.
      </p>
      ...
      <div class="mb-4">
        ...
        <p>6 months, 1 year or 2 years</p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Receive compensation, wages, or any similar from individuals or companies in Indonesia without a permit.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>A personal bank statement with a minimum equivalent amount of USD $2000. The statement must cover the last 3 months and include your name, the date, and the account balance.</li>
          <li>Application form signed by the applicant.</li>
          <li>ID card and family card (KK) of the Indonesian spouse (status already changed to married/kawin).</li>
          <li>Proof of registration according to the Representative of the Republic of Indonesia/authorized agency in the field of civil registration and vital statistics that has been translated into Indonesian by a sworn translator if the wedding ceremony takes place outside of Indonesia.</li>
          <li>Marriage book/certificate issued by the ministry or authorized institution if the wedding ceremony takes place in Indonesia.</li>
        </ul>
      </div>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E31A - Spouse of Indonesian Citizen.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"
          class="px-4 py-2 bg-teal-600 text-white text-sm rounded hover:bg-teal-700 transition">
          Apply Now
        </a>
      </div>
    </div>

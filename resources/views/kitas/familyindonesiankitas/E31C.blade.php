...
<head>
  ...
  <title>Evisas - E31C - Child of Indonesian Citizen</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E31C - Child of Indonesian Citizen</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>E31C - Child of Indonesian Citizen</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E31C - Child of Indonesian Citizen -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E31C - Child of Indonesian Citizen</h2>
      <p class="text-sm text-gray-600 mb-4">
        This KITAS is for a child of married parents, where one parent is an Indonesian citizen.
      </p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Parent’s marriage certificate or Marriage book or marriage certificate issued by the competent ministry or institution (if the wedding ceremony was held in Indonesia territory).</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E31C - Child of Indonesian Citizen.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

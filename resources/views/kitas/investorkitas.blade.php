...
<head>
  ...
  <title>Evisas - E28A - Investor Kitas</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E28A - Investor Kitas</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E28A - Investor Kitas -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E28A - Investor Kitas</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is for investors who want to stay in Indonesia for 1 or 2 years.
      </p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>IDR 17,000,000 – Regular 14 business days processing time</li>
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>IDR 22,000,000 – Priority 7 business days processing time</li>
        </ul>

        <p><strong>2 years visa</strong></p>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>IDR 25,000,000 – Regular 14 business days processing time</li>
          <li>IDR 27,000,000 – Priority 7 business days processing time</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Carry out activities related to business, investment, and company establishment.</li>
          <li>Bring eligible members of your family.</li>
          <li>Conduct activities as a member of the board of directors or commissioners of the company in which you are investing.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Do work that is not in accordance with the residence permit.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>PMA (Foreign Investment Company) company document.</li>
          <li>Passport that is valid for at least 6 (six) months.</li>
          <li>A recent color passport-sized photograph.</li>
          ...
          <li>Company must have a capital of Rp. 10,000,000,000 (one billion rupiah) or equivalent in the guarantor company listed in the Ministry of Investment/Indonesian Investment Coordinating Board (BKPM).</li>
          <li>Ministry of Law and Human Rights Decree regarding the legalization of the establishment of the company.</li>
          <li>Company current account balance (last 2–3 months).</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Additional Information</h3>
        <p class="text-sm text-gray-700">Available for Single entry / Multiple entry e-Visa. Applicant applying <strong>INSIDE</strong> Indonesia is also allowed.</p>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E28A - Investor Kitas.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

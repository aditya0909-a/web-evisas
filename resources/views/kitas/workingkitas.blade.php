    ...
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>USD 600 (Visa Fee) + IDR 3,000,000 (Work Permit) + Insurance</li>
          <li>IDR 17,500,000 – Regular (10 business days processing time)</li>
          <li>IDR 18,000,000 – Priority (3 business days processing time)</li>
        </ul>
        <p><strong>1 year visa</strong></p>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>USD 1,200 (Visa Fee) + IDR 3,000,000 (Work Permit) + Insurance</li>
          <li>IDR 19,500,000 – Regular (10 business days processing time)</li>
          <li>IDR 20,000,000 – Priority (3 business days processing time)</li>
        </ul>

        <p class="text-sm font-medium text-gray-700 underline mt-3">Applying from WITHIN Indonesia</p>
        <p><strong>6 months visa (Conversion)</strong></p>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>USD 600 (Visa Fee) + IDR 3,000,000 (Work Permit) + Insurance</li>
          <li>IDR 17,500,000 – Regular (10 business days processing time)</li>
          <li>IDR 18,000,000 – Priority (3 business days processing time)</li>
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>USD 1,200 (Visa Fee) + IDR 3,000,000 (Work Permit) + Insurance</li>
          <li>IDR 20,000,000 – Regular (10 business days processing time)</li>
          <li>IDR 23,000,000 – Priority (3 business days processing time)</li>
        </ul>
      </div>

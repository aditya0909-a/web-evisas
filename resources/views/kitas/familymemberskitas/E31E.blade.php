  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      ...
      <div class="mb-4">
        ...
        <p>6 months, 1 year, 2 years, 5 years or 10 years. <a href="/landingpage/extention/familykitasextention" class="text-blue-600 underline">Please click here for detailed information on extension.</a></p>
      </div>

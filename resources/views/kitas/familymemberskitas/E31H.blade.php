...
<head>
  ...
  <title>Evisas - E31H - Parent of KITAS holder</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E31H - Parent of KITAS holder</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>E31H - Parent of KITAS holder</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: E31H - Parent of KITAS holder -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">E31H - Parent of KITAS holder</h2>
      ...
      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
            ...
            <li><strong>IDR 17,000,000</strong> - Priority 7 business days.</li>
            </ul>
      ...
      <div class="mb-4">
        ...
        <p>6 months, 1 year or 2 years. <a href="/landingpage/extention/familykitasextention" class="text-blue-600 underline">Please click here for detailed information on extension.</a></p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>A personal bank statement showing a minimum equivalent amount of USD $2000. The statement must cover the last 3 months and include the name, the date, and the account balance.</li>
          <li>The child's birth certificate has been translated into Indonesian by a sworn translator<sup>*</sup>.</li>
          <li>The child’s valid visa/Limited Stay Permit (ITAS)/Permanent Stay Permit (ITAP).</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Additional document required for applicant applying from WITHIN Indonesia</h3>
        <p>Single entry or Multiple entry eVisa</p>
      </div>

      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the E31H - Parent of KITAS holder.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

...
<head>
  ...
  <title>Evisas - New PMA - Foreign Investment Company</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">New PMA - Foreign Investment Company</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>New PMA - Foreign Investment Company</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">New PMA - Foreign Investment Company</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p>Start From<strong>IDR 25,000,000</strong> - 30 business days processing time</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Period of validity</h3>
        <p>Permanently valid.</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">With this company, you <span class="text-green-600">CAN</span>:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Fully own a business in Indonesia as a foreign investor.</li>
          <li>Manage and operate your business under Indonesian law.</li>
          <li>Apply for a Foreign Investment <a href="#" class="text-blue-600 underline">KITAS</a> (work permit) for directors and commissioners.</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">With this company, you <span class="text-red-600">CANNOT</span>:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Engage in activities reserved for Indonesian-owned companies in certain sectors.</li>
          <li>Operate without complying with Indonesian regulations on foreign investments.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Evisas application form.</li>
          <li>Choose company name (provide 3 different name options) and business address.</li>
          <li>Select business purpose/business category.</li>
          <li>Choose shareholders and percentage share allocations.</li>
          <li>Execute company deed of establishment with the notary.</li>
          <li>Scan of the identity and signature pages of shareholders' passports (no photos, must be a color scan).</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>NPWP (personal tax registration per shareholder)</li>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the New PMA - Foreign Investment Company.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

...
<head>
  ...
  <title>Evisas - Close PMA Company (Company Dissolution)</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Close PMA Company (Company Dissolution)</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>Close PMA Company (Company Dissolution)</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Close PMA Company (Company Dissolution) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">Close PMA Company (Company Dissolution)</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p>Start From <strong>IDR 15,000,000</strong></p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Processing Time</h3>
        <p><strong>60–90 business days</strong> – Includes tax clearance and legal process</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Steps Involved in Dissolution</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Hold General Meeting of Shareholders (RUPS) and Notarial Deed of Dissolution</li>
          <li>Submission to Ministry of Law and Human Rights (AHU)</li>
          <li>Tax audit and clearance from Directorate General of Taxes</li>
          <li>Revocation of Business License (NIB) via OSS system</li>
          <li>Final announcement in State Gazette (BNRI)</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold text-red-600">Important Notes</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Company must not have active tax debt or unsettled obligations</li>
          <li>Process requires valid NPWP and final monthly tax reports</li>
          <li>Legal dissolution will be published in the State Gazette of Indonesia</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>All company deeds and amendments</li>
          <li>Financial statements (latest 2 years)</li>
          <li>Company NPWP, NIB, and OSS login access</li>
          <li>KTP/Passport of shareholders and directors</li>
        </ul>
      </div>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to Close PMA Company (Company Dissolution).\nCould you please assist me with the closure process? Thank you!`)"
          target="_blank"
    ...
    <div class="max-w-3xl mx-auto text-sm text-gray-600 mb-10 px-6">
      ...
      <ul class="list-disc pl-6 space-y-1">
        <li>Tax audit and clearance is mandatory before legal closure.</li>
        <li>Company must ensure no liabilities or pending lawsuits.</li>
        <li>We recommend appointing a tax consultant to assist with audit phase.</li>
      </ul>
    </div>

...
<head>
  ...
  <title>Evisas - New Individual Indonesian Investment</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">New Individual Indonesian Investment</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>New Individual Indonesian Investment</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: New Individual Indonesian Investment -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">New Individual Indonesian Investment</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p>Start From <strong>IDR 2,500,000</strong> - 14–30 business days processing time</p>
      </div>
      ...
      <div class="mb-4">
        <h3 class="font-semibold">With this setup, you <span class="text-green-600">CAN</span>:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Legally register a sole proprietorship in Indonesia under an individual Indonesian citizen.</li>
          <li>Run small to medium-sized businesses in permitted sectors.</li>
          <li>Obtain necessary operational licenses, tax ID (NPWP), and NIB (Business Identification Number).</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">With this setup, you <span class="text-red-600">CANNOT</span>:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Include foreign ownership or investment.</li>
          <li>Convert into legal entities such as PT or CV (without re-registration).</li>
          <li>Engage in sectors that require higher capital or multiple shareholders.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>KTP and NPWP of the Indonesian individual.</li>
          <li>Business address and description of business activity.</li>
          <li>Application form from Evisas.</li>
          <li>Proof of domicile or virtual office agreement (if needed).</li>
        </ul>
      </div>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the New Individual Indonesian Investment.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

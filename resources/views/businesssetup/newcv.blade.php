...
<head>
  ...
  <title>Evisas - New CV - Commanditaire Vennootschap</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">New CV - Commanditaire Vennootschap</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>New CV - Commanditaire Vennootschap</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: New CV - Commanditaire Vennootschap -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">New CV - Commanditaire Vennootschap</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p>Start From<strong>IDR 8,500,000</strong> - 14–30 business days processing time</p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Establish a partnership business between active and silent partners.</li>
          <li>Operate legally in Indonesia as a CV (non-legal entity structure).</li>
          <li>Register for NPWP, business domicile, and obtain operational permits.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Be owned by foreign nationals.</li>
          <li>Raise investment capital through issuing shares.</li>
          <li>Operate in sectors restricted to certain legal entity types (e.g., PMA).</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Company name options (minimum 3), business address, and business field.</li>
          <li>Data of active partner(s) and silent partner(s) with share contributions.</li>
          <li>KTP, NPWP, and passport scan of partners (must be clear color scan).</li>
          <li>Execution of deed of establishment before the notary.</li>
        </ul>
      </div>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the formation of a New CV - Commanditaire Vennootschap.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

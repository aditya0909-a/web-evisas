...
<head>
  ...
  <title>Evisas - Change PMA - Foreign Investment Company</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Change PMA - Foreign Investment Company</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <a href="/landingpage/businesssetup" class="hover:underline text-blue-600">Business Setup</a> › 
    <span>Change PMA - Foreign Investment Company</span>
  </div>
</div>
...
<<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Change PMA - Foreign Investment Company -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">Change PMA - Foreign Investment Company</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p>Start From <strong>IDR 25,000,000</strong></p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Processing Time</h3>
        <p>Estimated <strong>14–30 business days</strong> depending on approval and documentation</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Types of Changes You <span class="text-green-600">CAN</span> Apply:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Change of shareholders (foreign or local ownership adjustments)</li>
          <li>Change of company name or business address</li>
          <li>Change of business activity (KBLI codes update)</li>
          <li>Change of board of directors/commissioners</li>
          <li>Change of capital structure or ownership percentage</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Important Notes <span class="text-red-600">CANNOT</span> be done without:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Approval from shareholders and board meeting (RUPS)</li>
          <li>Updated company deed signed before a notary</li>
          <li>Notification to Ministry of Law and Human Rights (AHU)</li>
          <li>Complying with BKPM/OSS reporting requirements</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Current company deed (latest version)</li>
          <li>Original shareholder passport/KTP scans (color)</li>
          <li>Notarial deed of change (to be processed)</li>
          <li>Tax number (NPWP) and Business Registration (NIB)</li>
          <li>Board resolution minutes (RUPS)</li>
        </ul>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Price above includes</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Company Change Document</li>
          <li>OSS (Online Single Submission)</li>
        </ul>
      </div>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to inquire about changing a PMA (Foreign Investment Company).\nCould you please assist me with the process and documentation? Thank you!`)"
          target="_blank"
    ...
    <div class="max-w-3xl mx-auto text-sm text-gray-600 mb-10 px-6">
      ...
      <ul class="list-disc pl-6 space-y-1">
        <li>Prices may vary based on the complexity of the requested changes.</li>
        <li>Ensure your financial and tax obligations are up to date before initiating changes.</li>
        <li>Processing time may be extended if documentation is incomplete or requires government clarification.</li>
      </ul>
    </div>

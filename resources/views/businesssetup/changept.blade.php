...
<head>
  ...
  <title>Evisas - Change PT - Indonesian Investment Company</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Change PT - Indonesian Investment Company</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>Change PT - Indonesian Investment Company</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Change PT - Indonesian Investment Company -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">Change PT - Indonesian Investment Company</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p>Start From <strong>IDR 16,500,000</strong></p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Processing Time</h3>
        <p>Estimated <strong>10–20 business days</strong> depending on approval and documentation</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Types of Changes You <span class="text-green-600">CAN</span> Apply:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Change of shareholders (local individuals or entities)</li>
          <li>Change of company name or address</li>
          <li>Update KBLI (business classification codes)</li>
          <li>Change of board members (Directors or Commissioners)</li>
          <li>Capital increase or ownership adjustment</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Latest company deed and SK Kemenkumham</li>
          <li>KTP, NPWP of shareholders and directors</li>
          <li>Board resolution (RUPS)</li>
          <li>Business license (NIB) and company tax documents</li>
        </ul>
      </div>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to update my Indonesian PT company data.\nCould you please assist me with the process? Thank you!`)"
          target="_blank"
    ...
    <div class="max-w-3xl mx-auto text-sm text-gray-600 mb-10 px-6">
      ...
      <ul class="list-disc pl-6 space-y-1">
        <li>Quoted price is for standard changes; complex cases may incur additional fees.</li>
        <li>Ensure your company tax filings are up to date before making structural changes.</li>
        <li>All legal changes must follow current Indonesian Company Law (UU No. 40 Tahun 2007).</li>
      </ul>
    </div>

...
<head>
  ...
  <title>Evisas - New PT - Indonesian Investment Company</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">New PT - Indonesian Investment Company</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>New PT - Indonesian Investment Company</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">New PT - Indonesian Investment Company</h2>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p>Start From<strong>IDR 16,500,000</strong> - 30 business days processing time</p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Fully own and operate a business in Indonesia as an Indonesian citizen.</li>
          <li>Conduct business activities across various sectors within Indonesia.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Have foreign ownership; must be owned entirely by Indonesian citizens.</li>
          <li>Engage in certain sectors reserved for foreign investment.</li>
        </ul>
      </div>
      ...
      <div class="flex gap-3 mt-6">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the New PT - Indonesian Investment Company.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

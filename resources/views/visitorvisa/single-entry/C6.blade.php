...
<head>
  ...
  <title>Evisas - C6 - Single Entry Social, Humanitarian,Volunteer Visa (B211)</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">C6 - Single Entry Social, Humanitarian,Volunteer Visa (B211)</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>C6 - Single Entry Social, Humanitarian,Volunteer Visa (B211)</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: C6 - Single Entry Social, Humanitarian,Volunteer Visa (B211) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">C6 - Single Entry Social, Humanitarian, Volunteer Visa (B211)</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is intended for those seeking to participate in volunteer programs. It allows you to stay for 60 days and can be extended twice, each time adding 60 days, for a total stay of up to 180 days.
      </p>
      ...
      <div class="mb-4">
        ...
        <p>60 days (extendable ×2, 180 days MAX). 
          <a href="/landingpage/extention/singleentryextention" class="text-blue-600 underline">Please click here for detailed information on extension.</a>
        </p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Carry out activities related to voluntary or charity work.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Volunteer invitation letter.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the C6 - Single Entry Social, Humanitarian, Volunteer Visa (B211).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

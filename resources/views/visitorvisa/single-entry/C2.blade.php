...
<head>
  ...
  <title>Evisas - C2 - Single Entry Business Visa</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">C2 - Single Entry Business Visa</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>C2 - Single Entry Business Visa</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: C2 - Single Entry Business Visa (B211) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">C2 - Single Entry Business Visa (B211)</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is ideal for visitors who wish to carry out unpaid business related activities in Indonesia. It allows you to stay for 60 days and can be extended twice, each time adding 60 days, for a total stay of up to 180 days.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p><strong>IDR 3,500,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the C2 - Single Entry Business Visa (B211).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

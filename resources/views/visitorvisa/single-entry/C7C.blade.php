...
<head>
  ...
  <title>Evisas - C7C - Single Entry General Art Performer Visa (B211)</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">C7C - Single Entry General Art Performer Visa (B211)</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>C7C - Single Entry General Art Performer Visa (B211)</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: C7C - Single Entry General Art Performer Visa (B211) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">C7C - Single Entry General Art Performer Visa (B211)</h2>
      <p class="text-sm text-gray-600 mb-4">
        The C7C General Art Performer Visa is for professionals such as chefs, yoga instructors, bartenders, and photographers who are invited to participate in events across Indonesia. This visa allows you to showcase your talents legally while adhering to local regulations, making it ideal for short-term engagements.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p><strong>IDR 2,650,000</strong><span class="text-gray-500"> - 14 business days processing time</span></p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Receive hospitality benefits, including food, accommodation, and transport, while in Indonesia.</li>
          <li>Engage in activities related to tourism or visiting friends and family.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Work under an employment relationship with individuals or corporations in Indonesia.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Completed visa application and a copy of the performer’s contract with the event organizer.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the C7C - Single Entry General Art Performer Visa (B211).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

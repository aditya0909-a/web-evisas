...
<head>
  ...
  <title>Evisas - C10 - Single Entry Event Participant Visa</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">C10 - Single Entry Event Participant Visa</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>C10 - Single Entry Event Participant Visa</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: C10 - Single Entry Event Participant Visa (B211) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">C10 - Single Entry Event Participant Visa (B211)</h2>
      <p class="text-sm text-gray-600 mb-4">
        The C10 Visa is designed for individuals invited to Indonesia to participate in meetings, events, conventions, or exhibitions as a keynote speaker, lecturer, presenter, or public figure.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p><strong>IDR 3,000,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 4,750,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Length of Stay</h3>
        <p>60 days (extendable ×2, 180 days MAX). 
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Participate in speaking engagements, lectures, presentations, or activities as a public figure (without entering an employment relationship in Indonesia).</li>
          <li>Engage in tourism-related activities, or visit friends and family.</li>
          <li>Receive compensation or wages from individuals or corporations in Indonesia.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Remain in Indonesia beyond the visa's expiration date.</li>
          <li>Sell goods or services.</li>
          <li>Work in an employment relationship with an individual or corporation in Indonesia.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Letter of invitation from the person or organization responsible for the event, detailing the agenda and materials to be presented.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the C10 - Single Entry Event Participant Visa (B211).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

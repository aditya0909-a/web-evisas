...
<head>
  ...
  <title>Evisas - C18 - Single Entry Work Trial</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">C18 - Single Entry Work Trial</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>C18 - Work Trial</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: C18 - Single Entry Work Trial Visa (B211) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">C18 - Single Entry Work Trial Visa (B211)</h2>
      <p class="text-sm text-gray-600 mb-4">
        The C18 Work Trial Visa is designed for individuals seeking to experience working with an Indonesian company on a trial basis, allowing both the potential employee and employer to evaluate suitability before committing to full employment and associated costs. This visa does not allow the visa holder to receive any payment from the Indonesian company.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p><strong>IDR 5,500,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 7,000,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Length of Stay</h3>
        <p>90 days (not extendable).</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">With this visa, you <span class="text-green-600">CAN</span>:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Carry out activities related to work trials for a specified company in Indonesia.</li>
          <li>Carry out activities related to tourism, and visiting friends or family.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Receive payment for work carried out.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Letter of invitation to conduct work trials from a government agency or private company or institution.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the C18 - Single Entry Work Trial Visa (B211).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

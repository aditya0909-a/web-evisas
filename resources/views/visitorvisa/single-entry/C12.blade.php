...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">C12 - Single Entry Pre-Investment</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>C12 - Pre-Investment</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: C12 - Single Entry Pre-Investment Visa (B211) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">C12 - Single Entry Pre-Investment Visa (B211)</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is ideal for visitors who wish to investigate starting a business in Indonesia. It permits such activities as site visits, field surveys and/or feasibility studies. It allows you to stay for up to 180 days and is extendable for an additional 180 days.
      </p>
      ...
      <div class="mb-4">
        ...
        <p>180 days (extendable ×1, 360 days MAX).</p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">With this visa, you <span class="text-green-600">CAN</span>:</h3>
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Conduct activities related to starting a business, including field surveys and/or feasibility studies.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>A personal bank statement showing a minimum equivalent amount of USD $5000. The statement must cover the last 3 months and include your name, the date, and the account balance.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the C12 - Single Entry Pre-Investment Visa (B211).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

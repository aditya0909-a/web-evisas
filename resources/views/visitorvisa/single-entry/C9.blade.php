...
<head>
  ...
  <title>Evisas - C9 - Single Entry Short Course</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">C9 - Single Entry Short Course</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>C9 - Short Course</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: C9 - Single Entry Short Course Visa (B211) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">C9 - Single Entry Short Course Visa (B211)</h2>
      <p class="text-sm text-gray-600 mb-4">
        The C9 Visa is designed for individuals invited to have an activities related to benchmarking activity, short course, or short training program.
      </p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Conducting activities related to benchmarking activity, short course, or short training program.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li>Passport that is valid for at least 6 (six) months <em>from entry date</em>.</li>
          ...
          <li>Proof of registration or certificate as a participant.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the C9 - Single Entry Short Course Visa (B211).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

...
<head>
  ...
  <title>Evisas - D2 -Multiple Entry Business Visa (D212)</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">D2 -Multiple Entry Business Visa (D212)</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <a href="/landingpage/visitorvisa/multipleentry" class="hover:underline text-blue-600">Multiple Entry</a> › 
    <span>D2 -Multiple Entry Business Visa (D212)</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: D2 - Multiple Entry Business Visa (D212) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">D2 - Multiple Entry Business Visa (D212)</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is ideal for visitors engaging in unpaid business activities in Indonesia. It allows a 60-day stay and can be extended twice, each time adding 60 days, for a total stay of up to 180 days per visit. After 180 days, you must leave the country but can re-enter with the same visa.
      </p>

      <div class="mb-4">
        <h3 class="font-semibold">Price</h3>
        <p class="text-sm font-medium">1 year visa</p>
        <p><strong>IDR 7,500,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 9,250,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>

        <p class="text-sm font-medium mt-3">2 years visa</p>
        <p><strong>IDR 9,500,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 10,000,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>

        <p class="text-sm font-medium mt-3">5 years visa</p>
        <p><strong>IDR 15,000,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 16,500,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Length of Stay</h3>
        <p>60 days (with the option to extend 2 times, each extension allowing an additional 60 days). 
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Carry out activities related to business: conduct meetings, purchase and check goods at offices, factories, or production sites.</li>
          <li>Discuss, negotiate, and sign business contracts.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the D2 - Multiple Entry Business Visa (D212).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

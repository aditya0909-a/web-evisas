  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      ...
      <div class="mb-4">
        ...
        <p><strong>IDR 7,000,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 9,500,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>

        <p class="text-sm font-medium mt-3">2 years visa</p>
        <p><strong>IDR 9,750,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 11,250,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Length of Stay</h3>
        <p>180 days (extendable 1x, 180 days)</p>
      </div>

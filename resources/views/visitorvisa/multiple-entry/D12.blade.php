...
<head>
  ...
  <title>Evisas - D12 - Multiple Entry Pre-Investment Visa</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">D12 - Multiple Entry Pre-Investment Visa</span>
  </h2>
</div>
</section>
...
<div class="bg-gradient-to-r from-sky-900 to-blue-700 shadow-lg sticky text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>D12 - Multiple Entry Pre-Investment Visa</span>
  </div>
</div>

<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <!-- Section: D12 - Multiple Entry Pre-Investment Visa (D212) -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-2">D12 - Multiple Entry Pre-Investment Visa (D212)</h2>
      <p class="text-sm text-gray-600 mb-4">
        This visa is ideal for visitors who wish to investigate starting a business in Indonesia. It permits such activities as site visits, field surveys and/or feasibility studies. It allows you to stay for up to 180 days and can be extended once.
      </p>
      ...
      <div class="mb-4">
        ...
        <p><strong>IDR 9,000,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>
        ...
        <p><strong>IDR 11,000,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>
      </div>

      <div class="mb-4">
        <h3 class="font-semibold">Length of Stay</h3>
        <p>180 days (extendable 1x, 180 days)
        <a href="/landingpage/extention/multipleentrypreinvesmentextention" class="text-blue-600 underline">Please click here for detailed information on extension.</a>
      </p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Discuss, negotiate, and/or sign business contracts.</li>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Scan of Curriculum Vitae (CV).</li>
          <li>Scan of Travel Itinerary.</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the D12 - Multiple Entry Pre-Investment Visa (D212).\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

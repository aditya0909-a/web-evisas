  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      ...
      <div class="mb-4">
        ...
        <p><strong>IDR 5,000,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 6,500,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>
        ...
        <p><strong>IDR 9,00,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>

        <p class="text-sm font-medium mt-3">5 years visa</p>
        <p><strong>IDR 13,800,000</strong> - Regular <span class="text-gray-500">14 business days processing time</span></p>
        <p><strong>IDR 15,300,000</strong> - Priority <span class="text-gray-500">5 business days processing time</span></p>
      </div>

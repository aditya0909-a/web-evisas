...
<head>
  ...
  <title>Evisas - Visa on Arrival</title>
...
<div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
  ...
  <p class="text-sm text-gray-600 mb-4">
    Available for citizens from one of the <a href="/landingpage/eligible-country" class="text-blue-600 underline">VOA eligible countries</a> and who will be visiting Indonesia for holiday and tourism purposes.
  </p>
  ...
  <div class="mb-4">
    ...
    <p>30 days (extendable ×1, 30 days MAX). 
      <a href="/landingpage/extention/voaextention" class="text-blue-600 underline">Please click here for detailed information on extension.</a>
    </p>
  </div>

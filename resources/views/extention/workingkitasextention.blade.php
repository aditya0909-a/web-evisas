...
<head>
  ...
  <title>Evisas - Working KITAS Extension</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Working KITAS Extension</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>Working KITAS Extension</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Working KITAS Extension -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-4">Working KITAS Extension</h2>

      <p class="text-sm text-gray-700 mb-4">
        A Working KITAS extension follows the initial KITAS validity period. However, renewal is not available for a 6-month Working KITAS.
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>Visit the immigration office for your photo and fingerprints (takes 20–40 minutes).</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
           :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the Working KITAS Extension.\nCould you please assist me with the application process? Thank you!`)"
           target="_blank"

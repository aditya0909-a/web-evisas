...
<head>
  ...
  <title>Evisas - E- Visa VOA extension</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">E- Visa VOA extension</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>E- Visa VOA extension</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: VOA Extension -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-4">E- VOA Extension</h2>
      <p class="text-sm text-gray-700 mb-4">
        A VOA extension permits an additional 30 days stay for those visitors who either obtained their original 30-day VOA online OR at the airport on arrival in Indonesia. You must apply for the extension at least 14 days before your visa expires.
      </p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li><strong>IDR 950,000</strong> – Regular 5 business days processing time.</li>
          <li><strong>IDR 1,200,000</strong> – Priority 3 business days processing time.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <p class="text-sm text-gray-700">30 days</p>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>A clear picture of your passport ID page (Physical Passport will be required for non E-visa).</li>
      ...
      <div class="flex gap-2 mt-4">
        <a x-data
          :href="'https://wa.me/628113858165?text=' + encodeURIComponent(`Hello, I would like to apply for the VOA Extension.\nCould you please assist me with the application process? Thank you!`)"
          target="_blank"

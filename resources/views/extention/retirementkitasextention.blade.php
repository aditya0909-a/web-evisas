...
<head>
  ...
  <title>Evisas - Retirement KITAS Extension</title>
...
<section class="py-20 px-6 bg-[url('/images/rock.jpg')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Retirement KITAS Extension</span>
  </h2>
</div>
</section>
...
<div class="bg-[#021d3a] text-white text-sm px-4 py-3 md:px-20">
  <div class="max-w-7xl mx-auto pl-4 md:pl-20">
    ...
    <span>Retirement KITAS Extension</span>
  </div>
</div>
...
<div class="bg-cover py-12 overflow-hidden" style="background-image: url('{{ asset('images/patternocean1.png') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    ...
    <!-- Section: Retirement KITAS Extension -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto my-10">
      <h2 class="text-2xl font-bold text-[#1e293b] mb-4">Retirement KITAS Extension</h2>

      <p class="text-sm text-gray-700 mb-4">
        This KITAS can be extended in accordance with the initial period of validity.
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          <li><strong>1 year</strong>: <strong>IDR 9,500,000</strong> – Regular 14 business days processing time.</li>
          <li><strong>2 years</strong>: <strong>IDR 12,000,000</strong> – Regular 14 business days processing time.</li>
          <li><strong>5 years</strong>: <strong>IDR 19,000,000</strong> – Regular 14 business days processing time.</li>
        </ul>
      </div>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc pl-6 text-sm text-gray-700">
          ...
          <li>We will notify you within 7 business days to go to the immigration office for biometrics.</li>

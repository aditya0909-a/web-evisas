...
<head>
  ...
  <title>Evisas - Business Setup</title>
...
<section class="py-20 px-6 bg-[url('/images/ocean-bali.webp')] bg-cover bg-center text-white relative mt-[-64px] min-h-[250px]">
  ...
  <h2 class="text-4xl md:text-5xl mt-16 mb-2">
    <span class="underline decoration-yellow-500 underline-offset-4">Business Setup</span>
  </h2>
</div>
</section>
...
<div class="bg-cover py-16 overflow-hidden" style="background-image: url('{{ asset('images/patternocean.svg') }}')">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <!-- New PMA - Foreign Investment Company -->
      <div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
        <h3 class="text-xl font-semibold text-gray-800 mb-3">New PMA - Foreign Investment Company</h3>
        <p class="text-sm text-gray-600 mb-2">Company establishment for foreign investors, including NPWP registration and OSS licensing.</p>
        <p class="text-sm mb-2">Start From - <strong>IDR 25,000,000</strong></p>
        <div class="mt-auto flex gap-3">
          <a href="/landingpage/businesssetup/newpma" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
      </div>

      <!-- New PT - Indonesian Investment Company -->
      <div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
        <h3 class="text-xl font-semibold text-gray-800 mb-3">New PT - Indonesian Investment Company</h3>
        <p class="text-sm text-gray-600 mb-2">Establish an Indonesian-owned company complete with NPWP and OSS registration.</p>
        <p class="text-sm mb-2">Start From - <strong>IDR 16,500,000</strong></p>
        <div class="mt-auto flex gap-3">
          <a href="/landingpage/businesssetup/newpt" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
      </div>

      <!-- New CV - Commanditaire Vennootschap -->
      <div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
        <h3 class="text-xl font-semibold text-gray-800 mb-3">New CV - Commanditaire Vennootschap</h3>
        <p class="text-sm text-gray-600 mb-2">Setup of CV business structure including tax number (NPWP) and OSS licensing.</p>
        <p class="text-sm mb-2">Start From - <strong>IDR 8,500,000</strong></p>
        <div class="mt-auto flex gap-3">
          <a href="/landingpage/businesssetup/newcv" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
      </div>

      <!-- New Individual Indonesian Investment -->
      <div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
        <h3 class="text-xl font-semibold text-gray-800 mb-3">New Individual Indonesian Investment</h3>
        <p class="text-sm text-gray-600 mb-2">For individual Indonesian investors – includes company setup, OSS, and NPWP registration.</p>
        <p class="text-sm mb-2">Start From - <strong>IDR 2,500,000</strong></p>
        <div class="mt-auto flex gap-3">
          <a href="/landingpage/businesssetup/individualinvesment" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
      </div>

      <!-- Change PMA - Foreign Investment Company -->
      <div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
        <h3 class="text-xl font-semibold text-gray-800 mb-3">Change PMA - Foreign Investment Company</h3>
        <p class="text-sm text-gray-600 mb-2">Amendment of company data for foreign-owned companies, including OSS update.</p>
        <p class="text-sm mb-2">Start From - <strong>IDR 25,000,000</strong></p>
        <div class="mt-auto flex gap-3">
          <a href="/landingpage/businesssetup/changepma" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
      </div>

      <!-- Change PT - Indonesian Investment Company -->
      <div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
        <h3 class="text-xl font-semibold text-gray-800 mb-3">Change PT - Indonesian Investment Company</h3>
        <p class="text-sm text-gray-600 mb-2">Company change service for local companies including updates on OSS platform.</p>
        <p class="text-sm mb-2">Start From - <strong>IDR 16,500,000</strong></p>
        <div class="mt-auto flex gap-3">
          <a href="/landingpage/businesssetup/changept" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
      </div>

      <!-- Close PMA Company (Company Dissolution) -->
      <div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
        <h3 class="text-xl font-semibold text-gray-800 mb-3">Close PMA Company (Company Dissolution)</h3>
        <p class="text-sm text-gray-600 mb-2">Legal process of dissolving a foreign-owned company including closure documents.</p>
        <p class="text-sm mb-2">Start From - <strong>IDR 15,000,000</strong></p>
        <div class="mt-auto flex gap-3">
          <a href="/landingpage/businesssetup/closepma" class="flex-1 px-4 py-2 bg-gray-100 text-sm text-center rounded-lg hover:bg-gray-200 transition">Get Details</a>
        </div>
      </div>
